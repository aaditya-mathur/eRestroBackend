...
class Offer_model extends CI_Model
{
    ...
    <div class='image-container text-center'>
        <a href='" . $row['image_main'] . "' data-toggle='lightbox' data-gallery='gallery'>
            <img src='" . $row['image'] . "' class='img-fluid rounded mx-auto d-block' style='width: 100px; height: 100px; object-fit: contain;' alt='Image'>
        </a>
    </div>";

            $tempRow['banner'] = "
    <div class='image-container text-center'>
        <a href='" . $row['banner'] . "' data-toggle='lightbox' data-gallery='gallery'>
            <img src='" . $row['banner'] . "' class='img-fluid rounded mx-auto d-block' style='width: 100px; height: 100px; object-fit: contain;' alt='Banner'>
        </a>
    </div>";
