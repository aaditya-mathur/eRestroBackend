...
class Fund_transfers_model extends CI_Model
{
    ...
    function get_fund_transfers_list($user_id = '')
    {
        ...
        foreach ($transfers_res as $row) {
            ...
            $tempRow['opening_balance'] = $curreny . $row['opening_balance'];
            $tempRow['closing_balance'] = $curreny . $row['closing_balance'];
            $tempRow['amount'] = $curreny . $row['amount'];
