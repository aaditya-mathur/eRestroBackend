...
class Sales_inventory_model extends CI_Model
{
    public function get_sales_inventory_list(
        ...
        foreach ($user_details as $row) {
                ...
                $tempRow['name'] = (isset($row['name']) && $row['name'] != '') ?  stripslashes(stripslashes($row['name'])) : "-";
                $tempRow['partner_name'] = (isset($row['partner_name']) && $row['partner_name'] != '') ?  stripslashes(stripslashes($row['partner_name'])) : "-";
                $tempRow['stock'] = $stock;
