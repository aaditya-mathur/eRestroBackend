...
class Orders extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            $orders_count['draft'] = isset($_GET['partner_id']) ? orders_count("draft", $_GET['partner_id']) : orders_count("draft");
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin()) {
            ...
            if (!$this->form_validation->run()) {
                ...
                if (isset($deliver_by) && !empty($deliver_by)) {
                  update_details(['rider_id' => $deliver_by], ['order_id' => $order_id], 'order_transaction');
                }
