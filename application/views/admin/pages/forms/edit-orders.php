                                                        ...
                                                        <div class="row my-auto flex-column flex-md-row">
                                                            ...
                                                            <div class="col-auto my-auto">
                                                                <div class="price mb-2 list-view-price">
                                                                    Price: <?= $settings['currency'] . number_format((int)$item['price']) ?>
                                            ...
                                            <div class="card card-widget widget-user-2">
                                                ...
                                                <div class="card-footer p-0">
                                                    <ul class="nav flex-column">
                                                        ...
                                                        <li class="nav-item">
                                                            <a href="javascript:void(0)" class="nav-link text-info">Total(<?= $settings['currency'] ?>) (The total price is inclusive of the add-on amount.)<span class="float-right text-info" id='amount'>
