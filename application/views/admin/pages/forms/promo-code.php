                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="no_of_users" oninput="validateNumberInput(this)" value="<?= @$fetched_details[0]['no_of_users'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Minimum Order Amount <span class='text-danger text-sm'>*</span></label>
                                        <input type="number" class="form-control" name="minimum_order_amount" oninput="validateNumberInput(this)" value="<?= @$fetched_details[0]['minimum_order_amount'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Discount <span class='text-danger text-sm'>*</span></label>
                                        <input type="number" class="form-control" name="discount" oninput="validateNumberInput(this)" id="discount" value="<?= @$fetched_details[0]['discount'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" name="max_discount_amount" oninput="validateNumberInput(this)" id="max_discount_amount" value="<?= @$fetched_details[0]['max_discount_amount'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="image">Main Image <span class='text-danger text-sm'>*</span><small class="form-text text-muted">(Recommended size: 	73 × 45 px)</small></label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group col-md-6 <?= (isset($fetched_details[0]['repeat_usage']) && $fetched_details[0]['repeat_usage'] == '1') ? '' : 'd-none' ?>" id="repeat_usage_html">
                                        ...
                                        <input type="number" class="form-control" name="no_of_repeat_usage" oninput="validateNumberInput(this)" id="no_of_repeat_usage" value="<?= @$fetched_details[0]['no_of_repeat_usage'] ?>" min="0">
                                    </div>
                                </div>
