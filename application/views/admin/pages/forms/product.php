                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="image" class="col-sm-6 col-form-label">Main Image <span class='text-danger text-sm'>*</span><small class="form-text text-muted">(Recommended size: 100 × 100 px)</small></label>
                                            <div class="col-sm-12">
