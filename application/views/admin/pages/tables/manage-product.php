                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label for="restro_filter" class="col-form-label font-weight-bold">Filter By Partner</label>
                                    <select class="form-control partner-filter-select" name="partner_id" id="restro_filter">
                                        <option value="">Select a Partner</option>
                                        <?php foreach ($partners as $partner) { ?>
                                            <option value="<?= $partner['partner_id'] ?>"
                                                <?= (isset($product_details[0]['partner_id']) && $product_details[0]['partner_id'] == $partner['partner_id']) ? 'selected' : "" ?>>
                                                <?= output_escaping($partner['partner_name']) ?>
                                            </option>
                                        <?php } ?>
                                    </select>
                                </div>
