                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a class="text text-info"
                                href="<?= base_url('partner/home') ?>"><?= display_breadcrumbs(); ?></a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label for="image" class="col-sm-3 col-form-label">Main Image <span class='text-danger text-sm'>*</span><small class="form-text text-muted">(Recommended size: 100 × 100 px)</small></label>
                                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="calories" oninput="validateNumberInput(this)" placeholder="Enter calories in cal unit" name="calories" value="<?= @$product_details[0]['calories'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="total_allowed_quantity" class="col-sm-4 col-form-label">Total Allowed Quantity</label>
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="total_allowed_quantity" oninput="validateNumberInput(this)" value="<?= (isset($product_details[0]['total_allowed_quantity'])) ? $product_details[0]['total_allowed_quantity'] : ''; ?>" placeholder='Total Allowed Quantity' min="0">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="minimum_order_quantity" class="col-sm-4 col-form-label">Minimum Order Quantity</label>
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="minimum_order_quantity" oninput="validateNumberInput(this)" min="1" value="<?= (isset($product_details[0]['minimum_order_quantity'])) ? $product_details[0]['minimum_order_quantity'] : 1; ?>" placeholder='Minimum Order Quantity' min="0">
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control" id="add_on_price" oninput="validateNumberInput(this)" placeholder="Add ON Price" name="price" min="0">
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <label for="add_on_calories" class="col-sm-3 col-form-label">Calories </label>
                                                <div class="col-sm-12">
                                                    <input type="number" class="form-control" id="add_on_calories" oninput="validateNumberInput(this)" placeholder="Add On Calories" name="add_on_calories" min="0">
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="col-sm-12">
                                                            ...
                                                            ?>
                                                                <div id="general_price_section">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            <input type="number" name="simple_price" oninput="validateNumberInput(this)" class="form-control stock-simple-mustfill-field price" value="<?= $product_variants[0]['price'] ?>" min='0' step="0.01">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="type" class="col-md-2">Special Price:</label>
                                                                        <div class="col-md-12">
                                                                            <input type="number" name="simple_special_price" oninput="validateNumberInput(this)" class="form-control  discounted_price" value="<?= $product_variants[0]['special_price'] ?>" min='0' step="0.01">
                                                                        </div>
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <div class="col">
