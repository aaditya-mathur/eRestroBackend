                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" oninput="validateNumberInput(this)" name="no_of_users" value="<?= @$fetched_details[0]['no_of_users'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Minimum Order Amount <span class='text-danger text-sm'>*</span></label>
                                        <input type="number" class="form-control" oninput="validateNumberInput(this)" name="minimum_order_amount" value="<?= @$fetched_details[0]['minimum_order_amount'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="">Discount <span class='text-danger text-sm'>*</span></label>
                                        <input type="number" class="form-control" oninput="validateNumberInput(this)" name="discount" id="discount" value="<?= @$fetched_details[0]['discount'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" oninput="validateNumberInput(this)" name="max_discount_amount" id="max_discount_amount" value="<?= @$fetched_details[0]['max_discount_amount'] ?>" min="0">
                                    </div>
                                    <div class="form-group col-md-6">
