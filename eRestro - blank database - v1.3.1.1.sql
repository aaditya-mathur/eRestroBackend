...
--
-- Database: `u416548076_erestro_test`
--
...
CREATE TABLE `order_transaction` (
  ...
  `rider_id` int(11) DEFAULT NULL,
  `admin_payment` float DEFAULT NULL,
  `partner_payment` float DEFAULT NULL,
  `rider_payment` float DEFAULT NULL,
  `delivery_tip` float NOT NULL DEFAULT 0,
  `total_amount` float NOT NULL,
  `settelment_status` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
...
CREATE TABLE `pending_orders` (
  ...
  `rejected_riders` longtext DEFAULT NULL,
  `date_created` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, '127.0.0.1', 'Administrator', '$2y$12$ErsmK/gx3t1oSyIlbKsMcepA2SpvC31PkMw6nJg715rN/kjsjjNZS', 'admin@gmail.com', '9876543210', 'phone', NULL, 0, 0.0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1268889823, 1763968783, 1, 'ADMIN', NULL, NULL, 0.00, NULL, 0.00, NULL, 91, NULL, '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'dJXa6kH3Tzm6NBGwON5fhe:APA91bEFYijAUaRSRliyj0JXMTFm7SRGtXBFWoIOwH8f7VwkdG5xy0JsUpBH8sqO-_dGGZFxkP1oocj3kpKh-gOfkVDsaiqUYE_lunE7dlCqec9W-iL4kda6vO7qtOn7pFsAk6D2qLwza', NULL, '23.233278401061945', '69.64415181576143', '2020-06-30 10:20:08');
